...
typedef NS_ENUM(int, SSBLESENSSUNWRISTSTRAPWriteDataTypeEnum) {
    SSBLESENSSUNWRISTSTRAPWriteSetDateTime = 0x01,
    SSBLESENSSUNWRISTSTRAPWriteSetClock = 0x02,
    SSBLESENSSUNWRISTSTRAPWriteSetTargetSport = 0x03,
    SSBLESENSSUNWRISTSTRAPWriteSetProfile = 0x04,
    SSBLESENSSUNWRISTSTRAPWriteSetAntiLost = 0x05,
    SSBLESENSSUNWRISTSTRAPWriteSetSedentary = 0x06,
    SSBLESENSSUNWRISTSTRAPWriteSetAutoSleep = 0x07,
    SSBLESENSSUNWRISTSTRAPWriteGetQtyOfElec = 0x08,
    SSBLESENSSUNWRISTSTRAPWriteGetQtyOfElecReply = 0x09,
    SSBLESENSSUNWRISTSTRAPWriteSetSystemUser = 0x0A,
    SSBLESENSSUNWRISTSTRAPWriteGetSportData = 0x20,
    SSBLESENSSUNWRISTSTRAPWriteGetSportDataReply = 0x21,
    SSBLESENSSUNWRISTSTRAPWriteGetSleepData = 0x22,
    SSBLESENSSUNWRISTSTRAPWriteGetSleepDataReply = 0x23,
};
