...
- (void)viewDidLoad
{
    ...
    int language = [AppData getLangue];
    if (language != LangueTypeCN) {
        UIImage *image = [UIImage imageNamed:@"guide_addHeader2.png"];
        UIImageView *imageView = [self.m_iboGuideView viewWithTag:101];
