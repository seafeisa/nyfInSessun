...
- (void)initControlBtn {
    ...
    [cancelBtn setTitle:[AppData getString:@"cancel"]/*LOCALSTR_CANCEL*/ forState:UIControlStateNormal];
    ...
    [confirmBtn setTitle:[AppData getString:@"confirm"]/*LOCALSTR_CONFIRM*/ forState:UIControlStateNormal];
