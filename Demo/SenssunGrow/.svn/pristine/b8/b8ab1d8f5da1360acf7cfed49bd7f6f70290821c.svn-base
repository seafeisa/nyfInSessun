...
- (void)viewDidLoad
{
    ...
    _Firstlinegrowthnote.text = [AppData getString:@"growthNote"];
    [_WritenoteTitle setTitle:[AppData getString:@"writeNote"] forState:UIControlStateNormal];
    [_GrowthnoteEditTitle setTitle:[AppData getString:@"editor"] forState:UIControlStateNormal];
    _m_iboNoItemTips.text = [AppData getString:@"noNoteWritten"];
