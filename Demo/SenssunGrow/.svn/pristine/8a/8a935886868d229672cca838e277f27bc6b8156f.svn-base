...
//  Copyright (c) 2015年 camry. All rights reserved.
//

#ifndef __ChildGrowth_WHOStdData_h__
#define __ChildGrowth_WHOStdData_h__

const float WHO_DAYS_PER_MONTH = ((365.0 * 4 + 1) / 4 / 12);
