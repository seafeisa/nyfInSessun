...
//    _Editdiaryshelfviewdeletetitle.titleLabel.text = [AppData getString:@"delete"];
    [_EditdiaryshelfviewslectallTitle setTitle:[AppData getString:@"allslect"] forState:UIControlStateNormal];
    [_Editdiaryshelfviewdeletetitle setTitle:[AppData getString:@"delete"] forState:UIControlStateNormal];
//    _Editdairyshelfviewchangecovertitle.titleLabel.text = [AppData getString:@"changecover"];
    [_Editdairyshelfviewchangecovertitle setTitle:[AppData getString:@"changecover"] forState:UIControlStateNormal];
